        ...
        if (newPassword != null && confPassword != null && newPassword.equals(confPassword) && email != null) {
            try {
                ...
                Connection con = DriverManager.getConnection(
                        "jdbc:sqlserver://localhost:1433;databaseName=managementSignUp1;encrypt=false;trustServerCertificate=true",
                        "sa", "123"); // Thay your_password bằng mật khẩu thực tế của SQL Server
