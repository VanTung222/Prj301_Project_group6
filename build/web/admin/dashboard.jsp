...
<%@ page import="model.Admin, java.util.*" %>
<%
    ...
    int totalCustomers = stats != null ? (Integer) stats.get("totalCustomers") : 0;
    int totalOrders = stats != null ? (Integer) stats.get("totalOrders") : 0;
    double totalRevenue = stats != null ? (Double) stats.get("totalRevenue") : 0;
    Map<String, Integer> ordersByStatus = stats != null ? (Map<String, Integer>) stats.get("ordersByStatus") : new HashMap<>();
%>
<!DOCTYPE html>
<html lang="vi">
<head>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="stat-card">
                    ...
                    <h3 class="mb-2">$<%= String.format("%,.2f", totalRevenue) %></h3>
