    ...
    <div class="main-content">
        <div class="container-fluid">
          ...
          <div class="search-section mb-4">
                <form class="d-flex align-items-center" action="${pageContext.request.contextPath}/CustomerManagerAd" method="get">
                    ...
                    <div class="filter-box me-2">
                        <select class="form-select" name="roleFilter" onchange="this.form.submit()">
                            ...
                            <option value="0" ${param.roleFilter == '0' ? 'selected' : ''}>Admin</option>
                            <option value="1" ${param.roleFilter == '1' ? 'selected' : ''}>Khách hàng</option>
                        </select>
                    </div>
